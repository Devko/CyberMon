...
export const editorial = {
  ...
  footer: {
    ...
    disclaimer:
      ...
      "MITRE, NVD/NIST, CISA, FIRST, GDELT, Y Combinator/Algolia, arXiv, or Ransomwhere. " +
      "Charts aggregate public data; no individual CVE is news here, and no victim is " +
      "identified or identifiable anywhere on this site.",
    dataNote:
